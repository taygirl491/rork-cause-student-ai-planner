    ...
    try {
      ...
      if (mode === 'homework') {
        prompt = selectedImage
          ? 'Help me understand this homework problem. Explain the concept and guide me through the solution step by step.'
          : `Help me with this homework: ${input}. Explain the concept and guide me through the solution step by step.`;
        ...
        prompt = `Create a quiz with 5 questions based on this material:\n\n${input}`;
        messages.push({ role: 'user', content: prompt });
      }
