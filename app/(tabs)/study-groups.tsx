...
import { Plus, X, Users, Copy, Send, Paperclip, FileText, User } from 'lucide-react-native';
...
export default function StudyGroupsScreen() {
  const { studyGroups, createStudyGroup, joinStudyGroup, sendGroupMessage, deleteStudyGroup } = useApp();
  ...
  }, [showCreateGroupModal, showJoinGroupModal, showGroupDetailModal, scaleAnim]);
